...
pkg_dir = get_package_share_directory('ucsd_robocar_nav2_pkg')
node_list_input_path = os.path.join(pkg_dir, 'config', 'node_config.yaml')
node_packages_info_path = os.path.join(pkg_dir, 'config', 'node_pkg_locations_ucsd.yaml')
